...
public class TCPlanet extends TransitCalculator {
     ...
     */
    public TCPlanet(ISwissEph sw, int planet, int flags, double offset) {
     ...
     * @see swisseph.SweConst#SEFLG_JPLEPH
     */
    public TCPlanet(ISwissEph sw, int planet, int flags, double offset, int precalcCount,
        ...
        int vFlags = SweConst.SEFLG_EPHMASK | SweConst.SEFLG_TOPOCTR | SweConst.SEFLG_EQUATORIAL
            ...
            | SweConst.SEFLG_TRUEPOS | SweConst.SEFLG_TRANSIT_LONGITUDE | SweConst.SEFLG_TRANSIT_LATITUDE
    ...
    protected double getDegreePrecision(double jd) {
        ...
        switch ( idx ) {
            ...
            case 5: // Speed in distance
                ...
                if ( planet >= Extensions.maxBaryDist.length ) {
                    degPrec *= 0.05; // Rather random value???
                } else {
                    degPrec *= Extensions.maxBaryDist[planet];
                }
        }
